...
export const colorTokens = {
  ...
  gradient: {
    0: "background-color: #21D4FD; background-image: linear-gradient( 180deg,  rgba(122,231,248,1) 6.5%, rgba(86,118,191,1) 90.9% );",
    10: "background-color: #21D4FD; background-image: radial-gradient( circle farthest-corner at 10% 20%,  rgba(97,186,255,1) 0%, rgba(166,239,253,1) 90.1% );",
  },
};
